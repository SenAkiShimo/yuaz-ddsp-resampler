...
The active RC3.3 generation's `loudness.json` stores source oto active-RMS statistics for diagnostics. These source measurements do not determine the runtime gain.
