...
print('Yuaz 0.2.8ai.12 learned-control effect probe')
all_ok=True
...
print('\nRESULT:', 'learned residuals are non-zero' if all_ok else 'one or more packs are missing/collapsed; 0.2.8ai.12 carrier fallback remains active')
PY
