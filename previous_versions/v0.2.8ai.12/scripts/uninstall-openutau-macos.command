...
rm -rf "$RUNTIME"
echo "Removed only 0.2.8ai.12 runtime/wrapper."
echo "0.2.8ai.5, 0.2.8ai.4, 0.2.8ai.3, 0.2.8ai.2, 0.2.8ai.1, 0.2.8ai, 0.2.7 AI.3, RC4.2, and every voicebank generation outside .yuaz-0.2.8ai12 were preserved."
