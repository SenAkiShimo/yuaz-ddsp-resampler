...
def remote_size(url, user_agent='Yuaz-DDSP-Resampler/0.2.8ai.12', timeout=30):
...
def download_any(urls, dest, expected=0, user_agent='Yuaz-DDSP-Resampler/0.2.8ai.12', retries=120, timeout=60, label=None):
...
def download(url,dest,expected=0,user_agent='Yuaz-DDSP-Resampler/0.2.8ai.12',retries=120,timeout=60,label=None):
