...
FINAL="$APP/0.2.8ai.12"
TMP="$APP/.0.2.8ai.12-installing-$$"
...
assert c['engine_version']=='0.2.8ai.12'
assert c['port']==47885
assert c['runtime_id']=='yuaz-0.2.8ai.12-control-v12'
...
echo "0.2.8ai.12 is now the only installed Yuaz resampler version."
