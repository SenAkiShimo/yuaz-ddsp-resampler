...
echo "Yuaz 0.2.8ai.11 — Train ALL currently available learned-control packs"
...
echo "Next: ./deep-train-ai-voicebank.command to pin every compatible pack into .yuaz-0.2.8ai11"
