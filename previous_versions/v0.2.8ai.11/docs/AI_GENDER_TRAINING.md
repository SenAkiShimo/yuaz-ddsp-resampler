# AI Gender/Formant training — 0.2.8ai.11
...
When a compatible pack is present, a later `deep-train-voicebank.command` copies and pins it into the isolated 0.2.8ai.11 generation as `ai_gender_adapter.pt`. The source `.pt` is never modified.
