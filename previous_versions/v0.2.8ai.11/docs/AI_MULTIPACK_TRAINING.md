# Multi-pack developer training — 0.2.8ai.11
...
Then run `./deep-train-ai-voicebank.command` when you want to create a new `.yuaz-0.2.8ai11` generation containing frozen compatible copies of every available pack.
