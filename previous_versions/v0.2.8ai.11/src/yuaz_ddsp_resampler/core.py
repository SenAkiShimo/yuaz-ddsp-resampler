...
def blend_fullband_highband_refinement(base, foundation_output, continuity_output, sr, strength=1.0):
    """YH is a refinement layer in ai.11; it no longer creates the primary upper band."""
...
class YuazDDSPResamplerEngine:
    def __init__(self, repo, checkpoint, transition_ms=70.0, use_rvq=False, output_sr=44100, registry_path=None, ddsp_synthesis_sr=48000, fullband_crossover_start_hz=9000.0, fullband_crossover_full_hz=12100.0):
    ...
    def render(self, req):
        with self.render_lock:
            ...
            return {
                ...
                "ddsp_synthesis_backend": "dual-rate-48k-ddsp-body-v1",
