...
mkdir -p "$ROOT/control_models" "$HOME/Documents/Yuaz-DDSP-Backups/control-models/0.2.8ai.11"
EPOCHS="${YUAZ_HIGHBAND_EPOCHS:-10}"
BATCH="${YUAZ_HIGHBAND_BATCH:-4}"
OUT="$ROOT/control_models/highband_foundation-v2.pt"
echo "Yuaz 0.2.8ai.11 high-band hotfix — Train High-Band Foundation v2"
...
cp "$OUT" "$HOME/Documents/Yuaz-DDSP-Backups/control-models/0.2.8ai.11/highband_foundation-v2.pt"
shasum -a 256 "$OUT"
echo
