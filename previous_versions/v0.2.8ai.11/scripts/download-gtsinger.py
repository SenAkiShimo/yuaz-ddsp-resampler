...
REVISION = "main"
USER_AGENT = "Yuaz-DDSP-Resampler/0.2.8ai.11-technique-training"
PRESETS = {
    "chinese-core": [
        "Chinese/ZH-Alto-1/Breathy/**",
        "Chinese/ZH-Alto-1/Mixed_Voice_and_Falsetto/**",
        "Chinese/ZH-Alto-1/Pharyngeal/**",
        "Chinese/ZH-Tenor-1/Breathy/**",
        "Chinese/ZH-Tenor-1/Mixed_Voice_and_Falsetto/**",
        "Chinese/ZH-Tenor-1/Pharyngeal/**",
        "README.md",
    ],
    "chinese-breathy": [
        "Chinese/ZH-Alto-1/Breathy/**",
    ...
    "chinese-full": ["Chinese/**", "README.md"],
}
...
def manifest_path(local_dir, preset):
    return local_dir / f".yuaz-gtsinger-{preset}-manifest.json"
...
def main():
    ...
    if completed is False:
        return
    marker = local_dir / ".yuaz-gtsinger-preset"
