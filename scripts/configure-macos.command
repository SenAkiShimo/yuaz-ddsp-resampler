...
config={
 ...
 "host":"127.0.0.1", "port":47886, "engine_version":"0.2.8ai.14", "runtime_id":"yuaz-0.2.8ai.14-control-v14",
 "acoustic_base":"0.2.8ai.14-checkpoint-isolated", "transition_ms":70.0, "use_rvq":False,
 ...
 "registry_path":str(Path(sys.argv[3]).expanduser().resolve()), "state_namespace":".yuaz-0.2.8ai14",
 "previous_028ai13_readonly_state_namespace":".yuaz-0.2.8ai13", "preserve_ai13":True,
...
print('ai.13 preservation: ENABLED; no migration and no purge')
print('ai.14 state namespace:',config['state_namespace'])
print('ai.14 port:',config['port'])
PY
rm -f "$IMPORT_OUT"
