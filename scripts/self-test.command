...
require(art_v2.is_file(), 'articulation v2 runtime module missing')
...
require('single_source_articulation_hybrid_v2' in art_v2_text, 'articulation v2 bridge')
require('trajectory_revision": 2' in art_v2_text, 'articulation v2 diagnostics')
require('voiced_onset_zero' in art_v2_text, 'articulation v2 voiced-onset route')
require('do not suppress the broad trajectory again' in art_v2_text, 'articulation v2 no double-neutralization guard')
require('from .articulation_v2 import single_source_articulation_hybrid_v2' in server, 'server articulation v2 import')
require('_install_articulation_v2_patch()' in server, 'server articulation v2 runtime patch')
