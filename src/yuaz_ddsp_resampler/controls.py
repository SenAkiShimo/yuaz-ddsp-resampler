...
_CONTROL_RE = re.compile(
    r"(YM|YD|YH|YT|YB|YV|YG|YO|YF|YX|YP|YQ|YA|YR)([+-]?(?:\d+(?:\.\d*)?|\.\d+))",
    re.IGNORECASE,
)
...
def parse_yuaz_controls(flags):
    ...
    return YuazControls(
        ...
        refiner_bypass=values["YQ"], articulation_trajectory_bypass=values["YA"], raw_bypass=values["YR"],
    )